...
export default function Navbar() {
	return (
		<div className='flex justify-between items-center py-4 uppercase text-lg'>
			<img src={Logo} alt='All is well Logo' className='w-1/5' />
			<ul className='flex justify-between w-1/2 mx-auto'>
				<li>
					<NavLink
						to='/'
						className={({ isActive }) => (isActive ? 'active hover:text-gray-500 font-semibold' : 'hover:text-gray-500')}
					>
						Home
					</NavLink>
				</li>
